...
char const AreaTableEntryfmt[] = "iiinixxxxxisiiiiiffixxxxxxxx";
...
char const ChrClassesEntryfmt[] = "nnxsxxxnxxnnxxx";
...
char const LFGDungeonEntryfmt[] = "nsiiiiiiiiixxixixixxxnxxx";
