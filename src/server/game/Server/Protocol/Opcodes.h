...
enum Opcodes
{
    ...
    CMSG_NAME_QUERY                                   = 0x16DB, // 17399
    CMSG_REALM_QUERY                                  = 0x13D7, // 17399
    ...
    CMSG_AUTH_SESSION                                 = 0x0790, // 17399
    ...
    CMSG_CHAR_CREATE                                  = 0x17CF, // 17399
    CMSG_CHAR_CUSTOMIZE                               = 0x21DE,
    CMSG_CHAR_DELETE                                  = 0x1783, // 17399
    CMSG_CHAR_ENUM                                    = 0x1B9E, // 17399
    ...
    CMSG_CREATURE_QUERY                               = 0x1585, // 17399
    CMSG_DANCE_QUERY                                  = 0x4E07,
    CMSG_DB_QUERY_BULK                                = 0x1A8B, // 17399
    ...
    CMSG_DISMISS_CONTROLLED_VEHICLE                   = 0x072A, // 17399
    ...
    CMSG_GAMEOBJECT_QUERY                             = 0x15A4, // 17399
    ...
    CMSG_GOSSIP_HELLO                                 = 0x1414, // 17399
    ...
    CMSG_LEARN_TALENT                                 = 0x1901, // 17399
    ...
    CMSG_LOAD_SCREEN                                  = 0x160B, // 17399
    CMSG_LOGOUT_CANCEL                                = 0x20E0,
    CMSG_LOGOUT_REQUEST                               = 0x16E7, // 17399
    CMSG_LOG_DISCONNECT                               = 0x0380, // 17399
    CMSG_LOOT                                         = 0x0127,
    ...
    CMSG_MESSAGECHAT_SAY                              = 0x10BE, // 17399
    CMSG_MESSAGECHAT_WHISPER                          = 0x19B6, // 17399 
    CMSG_MESSAGECHAT_YELL                             = 0x1015, // 17399
    CMSG_MINIGAME_MOVE                                = 0x2A34,
    CMSG_MOUNTSPECIAL_ANIM                            = 0x2807,
    CMSG_MOVE_CHARM_TELEPORT_CHEAT                    = 0x0000,
    CMSG_MOVE_CHNG_TRANSPORT                          = 0x0C92, // 17399
    CMSG_MOVE_ENABLE_SWIM_TO_FLY_TRANS_ACK            = 0x0000,
    CMSG_MOVE_FALL_RESET                              = 0x0AC3, // 17399
    ...
    CMSG_RANDOMIZE_CHAR_NAME                          = 0x164B, // 17399
    CMSG_READY_FOR_ACCOUNT_DATA_TIMES                 = 0x1A0E, // 17399
    CMSG_READ_ITEM                                    = 0x2F16,
    CMSG_REALM_SPLIT                                  = 0x129F, // 17399
    CMSG_RECLAIM_CORPSE                               = 0x4036,
    CMSG_REDIRECTION_AUTH_PROOF                       = 0x1AA1, 
    ...
    CMSG_SET_ACTION_BUTTON                            = 0x129E, // 17399
    CMSG_SET_ACTIVE_MOVER                             = 0x171B, // 17399
    ...
    CMSG_SET_SELECTION                                = 0x1B76, // 17399
    ...
    CMSG_SET_SPECIALIZATION                           = 0x1104, // 17399
    ...
    CMSG_VIOLENCE_LEVEL                               = 0x1927, //17399
    ...
    MSG_MOVE_FALL_LAND                                = 0x031F, // 17399
    MSG_MOVE_HEARTBEAT                                = 0x0000, // 17399 - Error or FIX ?
    MSG_MOVE_JUMP                                     = 0x0B17,
    ...
    MSG_MOVE_SET_PITCH                                = 0x0717, // 17399 - Error or FIX ? 
    MSG_MOVE_SET_RAW_POSITION_ACK                     = 0x0000,
    MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT                 = 0x0000,
    MSG_MOVE_SET_RUN_MODE                             = 0x0A37, // 17399
    ...
    MSG_MOVE_SET_WALK_MODE                            = 0x0A3E, // 17399
    MSG_MOVE_SET_WALK_SPEED_CHEAT                     = 0x0000,
    MSG_MOVE_START_ASCEND                             = 0x061F, // 17399
    MSG_MOVE_START_BACKWARD                           = 0x0216, // 17399
    MSG_MOVE_START_DESCEND                            = 0x033A, // 17399
    MSG_MOVE_START_FORWARD                            = 0x0723, // 17399
    MSG_MOVE_START_PITCH_DOWN                         = 0x063A, // 17399
    MSG_MOVE_START_PITCH_UP                           = 0x0E0E, // 17399
    MSG_MOVE_START_STRAFE_LEFT                        = 0x0312, // 17399
    MSG_MOVE_START_STRAFE_RIGHT                       = 0x0722, // 17399
    MSG_MOVE_START_SWIM                               = 0x0712, // 17399
    MSG_MOVE_START_TURN_LEFT                          = 0x0A22, // 17399
    MSG_MOVE_START_TURN_RIGHT                         = 0x020E, // 17399
    MSG_MOVE_STOP                                     = 0x0A06, // 17399
    MSG_MOVE_STOP_ASCEND                              = 0x0A2F, // 17399
    MSG_MOVE_STOP_PITCH                               = 0x0A1B, // 17399
    MSG_MOVE_STOP_STRAFE                              = 0x0E0F, // 17399
    MSG_MOVE_STOP_SWIM                                = 0x0A1F, // 17399
    MSG_MOVE_STOP_TURN                                = 0x060A, // 17399
    ...
    SMSG_ACCOUNT_DATA_TIMES                           = 0x0890, // 17399
    ...
    SMSG_ACTION_BUTTONS                               = 0x0096, // 17399
    SMSG_ACTIVATETAXIREPLY                            = 0x6A37,
    SMSG_ADDON_INFO                                   = 0x0128, // 17399
    ...
    SMSG_AUTH_CHALLENGE                               = 0x016A, // 17399
    SMSG_AUTH_RESPONSE                                = 0x090E, // 17399
    ...
    SMSG_BATTLE_PET_JOURNAL                           = 0x0AC0,
    ...
    */
    ...
    SMSG_CHALLENGE_MODE_ALL_MAP_STATS                 = 0x0784,
    ...
    SMSG_CHAR_CREATE                                  = 0x0914, // 17399
    SMSG_CHAR_CUSTOMIZE                               = 0x04E0,
    SMSG_CHAR_DELETE                                  = 0x0806, // 17399
    SMSG_CHAR_ENUM                                    = 0x0193, // 17399
    ...
    SMSG_CLIENTCACHE_VERSION                          = 0x0825, // 17399
    ...
    SMSG_CREATURE_QUERY_RESPONSE                      = 0x01B4, // 17399
    SMSG_CRITERIA_DELETED                             = 0x039C, 
    SMSG_CRITERIA_UPDATE                              = 0x05D4, 
    ...
    SMSG_FAILED_PLAYER_CONDITION                      = 0x02CD, 
    ...
    SMSG_FLIGHT_SPLINE_SYNC                           = 0x7008, // temporrary
    ...
    SMSG_GAMEOBJECT_QUERY_RESPONSE                    = 0x0015, // 17399
    ...
    SMSG_GOSSIP_MESSAGE                               = 0x1508, // 17399
    ...
    SMSG_GUILD_REPUTATION_WEEKLY_CAP                  = 0x1A83, 
    ...
    SMSG_INITIAL_SPELLS                               = 0x1534, // 17399
    SMSG_INIT_CURRENCY                                = 0x1595, 
    ...
    SMSG_LEARNED_SPELL                                = 0x0830, // 17399
    ...
    SMSG_LOGIN_SETTIMESPEED                           = 0x01AF, // 17399
    SMSG_LOGIN_VERIFY_WORLD                           = 0x0896, // 17399
    SMSG_LOGOUT_CANCEL_ACK                            = 0x05D5, 
    SMSG_LOGOUT_COMPLETE                              = 0x00A8, // 17399
    ...
    SMSG_MONSTER_MOVE                                 = 0x114C, 
    SMSG_MONSTER_MOVE_TRANSPORT                       = 0x2004,
    SMSG_MOTD                                         = 0x082A, // 17399
    ...
    SMSG_MOVE_SET_CAN_FLY                             = 0x1353, // 17399
    ...
    SMSG_NAME_QUERY_RESPONSE                          = 0x00B7, // 17399
    SMSG_NEW_TAXI_PATH                                = 0x4B35,
    SMSG_NEW_WORLD                                    = 0x01AE, // 17399
    ...
    SMSG_PLAY_SPELL_VISUAL_KIT                        = 0x01C1, 
    SMSG_PLAY_TIME_WARNING                            = 0x4814,
    SMSG_PONG                                         = 0x0163, // 17399
    ...
    SMSG_QUESTGIVER_QUEST_DETAILS                     = 0x03ED, 
    ...
    SMSG_REMOVED_SPELL                                = 0x0523, // 17123
    ...
    SMSG_TALENTS_INFO                                 = 0x0924, // 17399
    ...
    SMSG_TRANSFER_PENDING                             = 0x08B5, // 17399
    SMSG_TRIGGER_CINEMATIC                            = 0x16AD, // 17399 
    SMSG_TRIGGER_MOVIE                                = 0x1198, 
    SMSG_TURN_IN_PETITION_RESULTS                     = 0x0F07,
    SMSG_TUTORIAL_FLAGS                               = 0x1F35, // 17399
    ...
    SMSG_UPDATE_OBJECT                                = 0x17D9, // 17399
    SMSG_UPDATE_SERVER_PLAYER_POSITION                = 0x0E84, 
    SMSG_UPDATE_WORLD_STATE                           = 0x13C8, 
