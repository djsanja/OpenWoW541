...
/// List of Opcodes - Not Updated for 5.4
enum Opcodes
{
    ...
    CMSG_NAME_QUERY                                   = 0x11E9, // 17538
    CMSG_REALM_QUERY                                  = 0x09E1, // 17538
    CMSG_ACTIVATETAXI                                 = 0x6E06,
    CMSG_ACTIVATETAXIEXPRESS                          = 0x0515,
    CMSG_ADDON_REGISTERED_PREFIXES                    = 0x10BD, // 17399
    CMSG_ADD_FRIEND                                   = 0x6527,
    CMSG_ADD_IGNORE                                   = 0x4726,
    CMSG_ADD_VOICE_IGNORE                             = 0x0F06,
    CMSG_ALTER_APPEARANCE                             = 0x7003, // temporrary
    ...
    CMSG_AUTH_SESSION                                 = 0x14DA, // 17538
    ...
    CMSG_CHANNEL_LIST                                 = 0x1C14, // 17399
    ...
    CMSG_CHAR_CREATE                                  = 0x08CD, // 17538
    CMSG_CHAR_CUSTOMIZE                               = 0x21DE,
    CMSG_CHAR_DELETE                                  = 0x09C0, // 17538
    CMSG_CHAR_ENUM                                    = 0x0848, // 17538
    CMSG_CHAR_FACTION_CHANGE                          = 0x2735,
    CMSG_CHAR_RACE_CHANGE                             = 0x0D24,
    CMSG_CHAR_RENAME                                  = 0x0289,
    ...
    CMSG_COMMENTATOR_SKIRMISH_QUEUE_COMMAND           = 0x7004, // temporrary
    ...
    CMSG_CREATURE_QUERY                               = 0x1647, // 17538
    CMSG_DANCE_QUERY                                  = 0x4E07,
    CMSG_DB_QUERY_BULK                                = 0x01E4, // 17538
    ...
    CMSG_DISMISS_CONTROLLED_VEHICLE                   = 0x1261, // 17538
    ...
    CMSG_GAMEOBJECT_QUERY                             = 0x1677, // 17538
    ...
    CMSG_GOSSIP_HELLO                                 = 0x1A3F, // 17399
    CMSG_GOSSIP_SELECT_OPTION                         = 0x136B, // 17399
    ...
    CMSG_GUILD_REQUEST_PARTY_STATE                    = 0x1885, // 17399
    CMSG_GUILD_ROSTER                                 = 0x0315, // 17399
    ...
    CMSG_LOAD_SCREEN                                  = 0x1148, // 17538
    CMSG_LOGOUT_CANCEL                                = 0x20E0,
    CMSG_LOGOUT_REQUEST                               = 0x03EC, // 17538
    CMSG_LOG_DISCONNECT                               = 0x14FA, // 17538
    CMSG_LOOT                                         = 0x0127,
    ...
    CMSG_MESSAGECHAT_RAID                             = 0x9997, 
    CMSG_MESSAGECHAT_RAID_WARNING                     = 0x9998, 
    CMSG_MESSAGECHAT_SAY                              = 0x14FC, // 17538
    CMSG_MESSAGECHAT_WHISPER                          = 0x14D8, // 17538 
    CMSG_MESSAGECHAT_YELL                             = 0x045C, // 17538
    ...
    CMSG_NPC_TEXT_QUERY                               = 0x17CF, // 17538
    CMSG_OBJECT_UPDATE_FAILED                         = 0x1A44, // 17538
    CMSG_OBJECT_UPDATE_RESCUED                        = 0x0000, // 17399 not sure
    ...
    CMSG_PING                                         = 0x11E6, // 17538
    CMSG_PLAYED_TIME                                  = 0x2097,
    CMSG_PLAYER_DIFFICULTY_CHANGE                     = 0x0000,
    CMSG_PLAYER_LOGIN                                 = 0x01E1, // 17538
    ...
    CMSG_QUEST_NPC_QUERY                              = 0x1084, // 17399
    CMSG_QUEST_POI_QUERY                              = 0x1287, // 17399
    CMSG_QUEST_QUERY                                  = 0x0D06,
    CMSG_RANDOMIZE_CHAR_NAME                          = 0x184C, // 17538
    CMSG_READY_FOR_ACCOUNT_DATA_TIMES                 = 0x144C, // 17538
    CMSG_READ_ITEM                                    = 0x2F16,
    CMSG_REALM_SPLIT                                  = 0x0449, // 17538
    CMSG_RECLAIM_CORPSE                               = 0x4036,
    CMSG_REDIRECTION_AUTH_PROOF                       = 0x0A93, // 17399
    ...
    CMSG_REQUEST_ACCOUNT_DATA                         = 0x0A82, 
    ...
    CMSG_SET_ACTION_BUTTON                            = 0x014C, // 17538
    CMSG_SET_ACTIVE_MOVER                             = 0x1A4D, // 17538
    ...
    CMSG_SET_PLAYER_DECLINED_NAMES                    = 0x1BD2, // 17399
    ...
    CMSG_SET_SELECTION                                = 0x07CD, // 17538
    ...
    CMSG_SET_SPECIALIZATION                           = 0x17DF, // 17538
    ...
    CMSG_SUSPEND_TOKEN                                = 0x0286, // 17399
    ...
    CMSG_TUTORIAL_CLEAR                               = 0x0885,
    CMSG_TUTORIAL_FLAG                                = 0x0000, // fix me cmsg
    CMSG_TUTORIAL_RESET                               = 0x2034,
    ...
    CMSG_VIOLENCE_LEVEL                               = 0x13CD, //17538
    ...
    MSG_MOVE_FALL_LAND                                = 0x17E9, // 17538
    MSG_MOVE_HEARTBEAT                                = 0x0AC8, // 17538
    ...
    MSG_MOVE_SET_RUN_MODE                             = 0x0748, // 17538
    ...
    MSG_MOVE_SET_WALK_MODE                            = 0x0BE1, // 17538
    MSG_MOVE_SET_WALK_SPEED_CHEAT                     = 0x0000,
    MSG_MOVE_START_ASCEND                             = 0x16C1, // 17538
    MSG_MOVE_START_BACKWARD                           = 0x12C0, // 17538
    MSG_MOVE_START_DESCEND                            = 0x0641, // 17538
    MSG_MOVE_START_FORWARD                            = 0x13C9, // 17538
    MSG_MOVE_START_PITCH_DOWN                         = 0x16E8, // 17538
    MSG_MOVE_START_PITCH_UP                           = 0x0FE1, // 17538
    MSG_MOVE_START_STRAFE_LEFT                        = 0x0EC8, // 17538
    MSG_MOVE_START_STRAFE_RIGHT                       = 0x0269, // 17538
    ...
    MSG_MOVE_STOP_SWIM                                = 0x0FC9, // 17538
    MSG_MOVE_STOP_TURN                                = 0x1749, // 17538
    MSG_MOVE_TELEPORT                                 = 0x0A2E, // 17538
    MSG_MOVE_TELEPORT_ACK                             = 0x390C,
    MSG_MOVE_TELEPORT_CHEAT                           = 0x3A10,
    MSG_MOVE_TIME_SKIPPED                             = 0x19B3,
    MSG_MOVE_TOGGLE_COLLISION_CHEAT                   = 0x0BC8, // 17538
    ...
    SMSG_ATTACKERSTATEUPDATE                          = 0x1BC0, // 17399
    SMSG_ATTACKSTART                                  = 0x0427, // 17399
    SMSG_ATTACKSTOP                                   = 0x050F, // 17399 
    ...
    SMSG_AURA_UPDATE                                  = 0x19B3, // 17399
    SMSG_AURA_UPDATE_ALL                              = 0x6916, 
    SMSG_AUTH_CHALLENGE                               = 0x0C5D, // 17538
    SMSG_AUTH_RESPONSE                                = 0x0D05, // 17538
    SMSG_AVAILABLE_VOICE_CHANNEL                      = 0x2E16,
    SMSG_AVERAGE_ITEM_LEVEL_INFORM                    = 0x04C5, 
    SMSG_BARBER_SHOP_RESULT                           = 0x6125,
    SMSG_BATTLEFIELD_LIST                             = 0x0ACC, 
    SMSG_BATTLEFIELD_MGR_EJECTED                      = 0x0091, 
    SMSG_BATTLEFIELD_MGR_EJECT_PENDING                = 0x0095, 
    SMSG_BATTLEFIELD_MGR_ENTERED                      = 0x06D9, 
    SMSG_BATTLEFIELD_MGR_ENTRY_INVITE                 = 0x14D8, 
    SMSG_BATTLEFIELD_MGR_EXIT_REQUEST                 = 0x05C5, 
    SMSG_BATTLEFIELD_MGR_QUEUE_INVITE                 = 0x0485, 
    SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE       = 0x0D88, 
    SMSG_BATTLEFIELD_MGR_STATE_CHANGE                 = 0x09C1, 
    SMSG_BATTLEFIELD_PLAYER_POSITIONS                 = 0x03CC, 
    SMSG_BATTLEFIELD_PORT_DENIED                      = 0x0F90, 
    SMSG_BATTLEFIELD_RATED_INFO                       = 0x079D, 
    ...
    // MOP Pet Battle
    /*
    SMSG_BATTLE_PET_UPDATES                           = 0x14CC,
    SMSG_BATTLE_PET_TRAP_LEVEL                        = 0x0A9D,
    SMSG_BATTLE_PET_SLOT_UPDATE                       = 0x149D,
    SMSG_BATTLE_PET_JOURNAL_LOCK_ACQUIRED             = 0x0DCD,
    SMSG_BATTLE_PET_JOURNAL_LOCK_DENIED               = 0x01C8,
    SMSG_BATTLE_PET_JOURNAL                           = 0x05B5, // 17399
    SMSG_BATTLE_PET_DELETE                            = 0x13D9,
    SMSG_BATTLE_PET_HEALED                            = 0x10C4,
    SMSG_BATTLE_PET_LICENCE_CHANGE                    = 0x1381,
    SMSG_PET_BATTLE_REQUEST_FAILED                    = 0x118C,
    SMSG_PET_BATTLE_PVP_CHALLENGE                     = 0x0FC0,
    SMSG_PET_BATTLE_LOCATION_FINALIZE                 = 0x1280,
    SMSG_PET_BATTLE_UPDATE_FULL                       = 0x0189,
    SMSG_PET_BATTLE_FIRST_ROUND                       = 0x1290,
    SMSG_PET_BATTLE_ROUND_RESULT                      = 0x0FC8,
    SMSG_PET_BATTLE_REPLACEMENT_MADE                  = 0x0C91,
    SMSG_PET_BATTLE_FINAL_ROUND                       = 0x06CC,
    SMSG_PET_BATTLE_FINISHED                          = 0x0CCC,
    SMSG_PET_BATTLE_CHAT_RESTRICTED                   = 0x01DD,
    SMSG_PET_BATTLE_MAX_GAME_LENGHT_WARNING           = 0x04C8
    */
    SMSG_BINDER_CONFIRM                               = 0x2835,
    SMSG_BINDPOINTUPDATE                              = 0x0404, // 17399
    SMSG_BINDZONEREPLY                                = 0x0000,
    SMSG_BREAK_TARGET                                 = 0x0105,
    SMSG_BUY_BANK_SLOT_RESULT                         = 0x0000,
    SMSG_BUY_FAILED                                   = 0x0D95, 
    ...
    SMSG_CALENDAR_SEND_NUM_PENDING                    = 0x078C, 
    SMSG_CALENDAR_UPDATE_INVITE_LIST                  = 0x0000,
    SMSG_CAMERA_SHAKE                                 = 0x4214,
    SMSG_CANCEL_AUTO_REPEAT                           = 0x041C, // 17399
    SMSG_CANCEL_COMBAT                                = 0x0281, 
    SMSG_CAST_FAILED                                  = 0x1598, 
    SMSG_CHALLENGE_MODE_COMPLETE                      = 0x0EC8,
    SMSG_CHALLENGE_MODE_REWARDS                       = 0x0AD8,
    SMSG_CHALLENGE_MODE_ALL_MAP_STATS                 = 0x11E6,
    SMSG_CHALLENGE_MODE_MAP_STATS_UPDATE              = 0x1098,
    SMSG_CHALLENGE_MODE_REQUEST_LEADERS               = 0x03D4,  
    SMSG_CHALLENGE_MODE_NEW_PLAYER_RECORD             = 0x07C9,
    SMSG_CHANNEL_LIST                                 = 0x052C, 
    SMSG_CHANNEL_MEMBER_COUNT                         = 0x6414,
    SMSG_CHANNEL_NOTIFY                               = 0x1760, // 17399
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x4417,
    SMSG_CHAR_CREATE                                  = 0x1007, // 17538
    SMSG_CHAR_CUSTOMIZE                               = 0x04E0,
    SMSG_CHAR_DELETE                                  = 0x0017, // 17538
    SMSG_CHAR_ENUM                                    = 0x040E, // 17538
    SMSG_CHAR_FACTION_CHANGE                          = 0x4C06,
    SMSG_CHAR_RENAME                                  = 0x12C6,
    SMSG_CHAT_IGNORED_ACCOUNT_MUTED                   = 0x02C5, 
    SMSG_CHAT_NOT_IN_PARTY                            = 0x6A14,
    SMSG_CHAT_PLAYER_AMBIGUOUS                        = 0x2F34,
    SMSG_CHAT_PLAYER_NOT_FOUND                        = 0x14D1, 
    SMSG_CHAT_RESTRICTED                              = 0x099C, 
    SMSG_CHAT_SERVER_DISCONNECTED                     = 0x1294, 
    SMSG_CHAT_SERVER_RECONNECTED                      = 0x04DD, 
    SMSG_CHAT_WRONG_FACTION                           = 0x6724,
    SMSG_CHECK_FOR_BOTS                               = 0x0000,
    SMSG_CLEAR_BOSS_EMOTES                            = 0x1395, 
    SMSG_CLEAR_COOLDOWN                               = 0x0627,
    SMSG_CLEAR_COOLDOWNS                              = 0x59B4,
    SMSG_CLEAR_FAR_SIGHT_IMMEDIATE                    = 0x2A04,
    SMSG_CLEAR_TARGET                                 = 0x4B26,
    SMSG_CLIENTCACHE_VERSION                          = 0x1037, // 17538
    ...
    SMSG_CORPSE_RECLAIM_DELAY                         = 0x04BB, // 17399
    SMSG_CREATURE_QUERY_RESPONSE                      = 0x011C, // 17538
    SMSG_CRITERIA_DELETED                             = 0x039C, 
    SMSG_CRITERIA_UPDATE                              = 0x082C, // 17399
    SMSG_CROSSED_INEBRIATION_THRESHOLD                = 0x2036,
    SMSG_CURRENCY_LOOT_REMOVED                        = 0x1DB4,
    SMSG_CURRENCY_LOOT_RESTORED                       = 0x30A0,
    SMSG_CUSTOM_LOAD_SCREEN                           = 0x03DC, 
    SMSG_DAMAGE_CALC_LOG                              = 0x2436,
    SMSG_DAMAGE_DONE_OBSOLETE                         = 0x0000,
    SMSG_DANCE_QUERY_RESPONSE                         = 0x2F06,
    SMSG_DB_REPLY                                     = 0x1406, // 17538
    SMSG_DEATH_RELEASE_LOC                            = 0x2F07,
    SMSG_DEBUG_RUNE_REGEN                             = 0x0C9C, 
    SMSG_DEFENSE_MESSAGE                              = 0x0314,
    SMSG_DESTROY_OBJECT                               = 0x04B4, // 17538
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                 = 0x4825,
    SMSG_DIFFERENT_INSTANCE_FROM_PARTY                = 0x0DD5, 
    SMSG_DISENCHANT_CREDIT                            = 0x12C9, 
    SMSG_DISMOUNT                                     = 0x2135,
    SMSG_DISMOUNTRESULT                               = 0x0CC5, 
    SMSG_DISPEL_FAILED                                = 0x0307,
    SMSG_DISPLAY_GAME_ERROR                           = 0x07D5, 
    SMSG_DONT_AUTO_PUSH_SPELLS_TO_ACTION_BAR          = 0x0BD9, 
    ...
    SMSG_GODMODE                                      = 0x0405, 
    SMSG_GOSSIP_COMPLETE                              = 0x7000, //temporary
    SMSG_GOSSIP_MESSAGE                               = 0x03FC, // 17538
    SMSG_GOSSIP_POI                                   = 0x1E0C, // 17399
    ...
    SMSG_GUILD_QUERY_RESPONSE                         = 0x0D42, // 17399
    ...
    SMSG_GUILD_REPUTATION_WEEKLY_CAP                  = 0x0457, // 17399
    SMSG_GUILD_RESET                                  = 0x1CB5,
    SMSG_GUILD_REWARDS_LIST                           = 0x1DB0,
    SMSG_GUILD_ROSTER                                 = 0x044E, // 17399
    ...
    SMSG_HOTFIX_INFO                                  = 0x1584,
    SMSG_HOTFIX_NOTIFY                                = 0x0EDC,
    SMSG_INITIALIZE_FACTIONS                          = 0x090F, // 17399
    SMSG_INITIAL_SPELLS                               = 0x1164, // 17538
    SMSG_INIT_CURRENCY                                = 0x0494, // 17399
    SMSG_INIT_WORLD_STATES                            = 0x0929, // 17399
    SMSG_INSPECT                                      = 0x0000,
    SMSG_INSPECT_HONOR_STATS                          = 0x109C, 
    SMSG_INSPECT_RATED_BG_STATS                       = 0x1498, 
    ...
    SMSG_ITEM_ADD_PASSIVE                             = 0x1384, 
    SMSG_ITEM_COOLDOWN                                = 0x4D14,
    SMSG_ITEM_ENCHANT_TIME_UPDATE                     = 0x0437, // 17399
    SMSG_ITEM_EXPIRE_PURCHASE_REFUND                  = 0x0F81, 
    SMSG_ITEM_PUSH_RESULT                             = 0x129D, 
    SMSG_ITEM_REFUND_INFO_RESPONSE                    = 0x15A3,
    SMSG_ITEM_REFUND_RESULT                           = 0x06C5, 
    SMSG_ITEM_REMOVE_PASSIVE                          = 0x1298, 
    SMSG_ITEM_SEND_PASSIVE                            = 0x0DDD, 
    ...
    SMSG_LEARNED_SPELL                                = 0x118E, // 17538
    SMSG_LEVELUP_INFO                                 = 0x0402, // 17399
    ...
    SMSG_LFG_PLAYER_INFO                              = 0x01A2, // 17399
    ...
    SMSG_LFG_SLOT_INVALID                             = 0x119D, 
    SMSG_LFG_TELEPORT_DENIED                          = 0x049D, 
    SMSG_LFG_UPDATE_LIST                              = 0x0000,
    SMSG_LFG_UPDATE_SEARCH                            = 0x54A1,
    SMSG_LFG_UPDATE_STATUS                            = 0x0E98, 
    SMSG_LFG_UPDATE_STATUS_NONE                       = 0x0A89, 
    ...
    SMSG_LIST_INVENTORY                               = 0x088D, // 17399
    SMSG_LOAD_CUF_PROFILES                            = 0x09CC, 
    SMSG_LOGIN_SETTIMESPEED                           = 0x0D17, // 17538
    SMSG_LOGIN_VERIFY_WORLD                           = 0x0896, // 17399
    SMSG_LOGOUT_CANCEL_ACK                            = 0x05D5, 
    SMSG_LOGOUT_COMPLETE                              = 0x0D95, // 17538
    SMSG_LOGOUT_RESPONSE                              = 0x14D5, 
    SMSG_LOG_XPGAIN                                   = 0x09CD, 
    SMSG_LOOT_ALL_PASSED                              = 0x0DC1, 
    SMSG_LOOT_CLEAR_MONEY                             = 0x2B37,
    SMSG_LOOT_CONTENTS                                = 0x0580, 
    ...
    SMSG_MESSAGECHAT                                  = 0x14AC, // 17538
    SMSG_MESSAGE_BOX                                  = 0x14D9, 
    SMSG_MINIGAME_SETUP                               = 0x6727,
    SMSG_MINIGAME_STATE                               = 0x2E17,
    SMSG_MIRRORIMAGE_DATA                             = 0x2634,
    SMSG_MISSILE_CANCEL                               = 0x03CD, 
    SMSG_MODIFY_COOLDOWN                              = 0x6016,
    SMSG_MONEY_NOTIFY                                 = 0x0DCC, 
    SMSG_MONSTER_MOVE                                 = 0x137A, // 17399
    SMSG_MONSTER_MOVE_TRANSPORT                       = 0x2004,
    SMSG_MOTD                                         = 0x04AC, // 17538
    ...
    SMSG_MOVE_SET_CAN_FLY                             = 0x0209, // 17538
    ...
    SMSG_MOVE_UPDATE_FLIGHT_SPEED                     = 0x160E, // 17399
    ...
    SMSG_NAME_QUERY_RESPONSE                          = 0x1407, // 17538
    SMSG_NEW_TAXI_PATH                                = 0x4B35,
    SMSG_NEW_WORLD                                    = 0x010F, // 17538
    SMSG_NEW_WORLD_ABORT                              = 0x0399, 
    ...
    SMSG_PAGE_TEXT_QUERY_RESPONSE                     = 0x0114, // 17399
    ...
    SMSG_PERIODICAURALOG                              = 0x1097, // 17399
    SMSG_PETGODMODE                                   = 0x2E36,
    SMSG_PETITION_ALREADY_SIGNED                      = 0x10CD, 
    ...
    SMSG_PLAY_SOUND                                   = 0x04A1, // 17399
    SMSG_PLAY_SPELL_VISUAL                            = 0x07D0, 
    SMSG_PLAY_SPELL_VISUAL_KIT                        = 0x01A5, // 17399
    SMSG_PLAY_TIME_WARNING                            = 0x4814,
    SMSG_PONG                                         = 0x005D, // 17538
    ...
    SMSG_QUESTGIVER_QUEST_DETAILS                     = 0x142D, // 17399
    ...
    SMSG_ROLE_POLL_BEGIN                              = 0x0CDC, 
    SMSG_RWHOIS                                       = 0x2437,
    SMSG_SELL_ITEM                                    = 0x6105,
    SMSG_SCENARIO_STATE                               = 0x009C, 
    SMSG_SCENARIO_POIS                                = 0x0C88, 
    SMSG_SCENARIO_PROGRESS_UPDATE                     = 0x0295, 
    SMSG_SEND_MAIL_RESULT                             = 0x4927,
    SMSG_SEND_UNLEARN_SPELLS                          = 0x11A2, // 17399
    ...
    SMSG_VOICE_SESSION_LEAVE                          = 0x08D0, 
    SMSG_VOICE_SESSION_ROSTER_UPDATE                  = 0x1291, 
    SMSG_VOICE_SET_TALKER_MUTED                       = 0x6E35,
    SMSG_VOID_ITEM_SWAP_RESPONSE                      = 0x78A2,
    SMSG_VOID_STORAGE_CONTENTS                        = 0x0F9C, 
    SMSG_VOID_STORAGE_FAILED                          = 0x078D, 
    SMSG_VOID_STORAGE_TRANSFER_CHANGES                = 0x06C9, 
    SMSG_VOID_TRANSFER_RESULT                         = 0x05C9,  
    SMSG_WAIT_QUEUE_FINISH                            = 0x06C8, 
    SMSG_WAIT_QUEUE_UPDATE                            = 0x05D1, 
    SMSG_WARDEN_DATA                                  = 0x12D9, 
    SMSG_WARGAME_CHECK_ENTRY                          = 0x3DA4,
    SMSG_WARGAME_REQUEST_SENT                         = 0x0E85, 
    SMSG_WEATHER                                      = 0x04A7, // 17399 
    SMSG_WEEKLY_LAST_RESET                            = 0x01D4, 
    SMSG_WEEKLY_RESET_CURRENCY                        = 0x3CA1,
    SMSG_WEEKLY_SPELL_USAGE                           = 0x1124, // 17399
    SMSG_WEEKLY_SPELL_USAGE_UPDATE                    = 0x11B5,
    SMSG_WHO                                          = 0x11C0, 
    SMSG_WHOIS                                        = 0x0D89, 
    SMSG_WORLD_SERVER_INFO                            = 0x052E, // 17399
    SMSG_WORLD_STATE_UI_TIMER_UPDATE                  = 0x4A14,
    SMSG_XP_GAIN_ABORTED                              = 0x1188, 
