...
enum Opcodes
{
    ...
    CMSG_DISMISS_CONTROLLED_VEHICLE                   = 0x0A56, 
    ...
    CMSG_OPENING_CINEMATIC                            = 0x16AD, // 17399
    ...
    CMSG_TUTORIAL_FLAG                                = 0x1F35, // 17399
    ...
    MSG_MOVE_SET_WALK_MODE                            = 0x0856, 
    MSG_MOVE_SET_WALK_SPEED_CHEAT                     = 0x0000,
    MSG_MOVE_START_ASCEND                             = 0x089F, 
    MSG_MOVE_START_BACKWARD                           = 0x08D2, 
    MSG_MOVE_START_DESCEND                            = 0x0893, 
    MSG_MOVE_START_FORWARD                            = 0x0A4B, 
    MSG_MOVE_START_PITCH_DOWN                         = 0x0A12, 
    MSG_MOVE_START_PITCH_UP                           = 0x0C02, 
    MSG_MOVE_START_STRAFE_LEFT                        = 0x0816, 
    MSG_MOVE_START_STRAFE_RIGHT                       = 0x0843, 
    MSG_MOVE_START_SWIM                               = 0x0C13, 
    MSG_MOVE_START_TURN_LEFT                          = 0x0A9E, 
    MSG_MOVE_START_TURN_RIGHT                         = 0x0A07, 
    MSG_MOVE_STOP                                     = 0x0813, 
    MSG_MOVE_STOP_ASCEND                              = 0x0A47, 
    MSG_MOVE_STOP_PITCH                               = 0x0AC7, 
    MSG_MOVE_STOP_STRAFE                              = 0x0A4A, 
    MSG_MOVE_STOP_SWIM                                = 0x0C93, 
    MSG_MOVE_STOP_TURN                                = 0x080A, 
    MSG_MOVE_TELEPORT                                 = 0x0C54, 
	...
	*/
    ...
    SMSG_LOGIN_VERIFY_WORLD                           = 0x0434, 
    ...
    SMSG_SEND_UNLEARN_SPELLS                          = 0x0523, // 17399
